  ...
  render() {
    return (
      <div className="main-content home">
        ...
        {/* <Link to="teachers/JavaScript/Ovi-Cotorogea">Ovi</Link>
        <Link to="teachers/Ajax/John-West">John West</Link>
        <Link to="teachers/ReactMagic/Merlin-Wizzard">Merlin</Link> */}
